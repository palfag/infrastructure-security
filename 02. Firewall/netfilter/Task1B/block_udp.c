...
int registerFilter(void) {
   ...
   hook1.hook = printInfo;                      // Connect my code to the hook                        
   hook1.hooknum = NF_INET_LOCAL_OUT;           // Which hook you want to connect to            
   hook1.pf = PF_INET;
   hook1.priority = NF_IP_PRI_FIRST;
   nf_register_net_hook(&init_net, &hook1);     // Register the hook
